...
> ⚠️ **Modèle à compléter et faire valider.** Mentions ⟨…⟩ à renseigner après
> immatriculation de la société (cf. `CEPICI-creation-entreprise-SAS.pdf`).
...
La marque et le logo **« MP² » / « Un succès inévitable »**, ainsi que les
éléments du Service, sont protégés. Toute reproduction non autorisée est interdite.

## Protection des données
Le traitement des données personnelles est décrit dans la **Politique de
confidentialité**, conforme à la Loi N°2013-450 du 19 juin 2013. Autorité de
